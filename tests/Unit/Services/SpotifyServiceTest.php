...
class SpotifyServiceTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        config([
            'Sound.spotify.client_id' => 'fake-client-id',
            'Sound.spotify.client_secret' => 'fake-client-secret',
        ]);
    ...
    {
        config(['Sound.spotify.client_id' => null]);
    ...
    {
        config([
            'Sound.spotify.client_id' => null,
            'Sound.spotify.client_secret' => null,
        ]);
