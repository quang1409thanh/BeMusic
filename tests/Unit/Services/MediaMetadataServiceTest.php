...
class MediaMetadataServiceTest extends TestCase
{
    ...
    public function testWriteAlbumCover(): void
    {
        ...
        $coverPath = '/Sound/public/img/album/foo.jpg';

        $this->imageWriter
            ->shouldReceive('write')
            ->once()
            ->with('/Sound/public/img/album/foo.jpg', 'dummy-src');
    ...
    public function testWriteArtistImage(): void
    {
        ...
        $imagePath = '/Sound/public/img/artist/foo.jpg';

        $this->imageWriter
            ->shouldReceive('write')
            ->once()
            ->with('/Sound/public/img/artist/foo.jpg', 'dummy-src');
