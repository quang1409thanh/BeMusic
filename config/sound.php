...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | sound provides the ability to prohibit or allow [default] downloading music
    |
    */
    ...
    */
    ...
    'misc' => [
        'home_url' => 'https://sound.dev',
        'docs_url' => 'https://docs.sound.dev',
        'sponsor_github_url' => 'https://github.com/users/phanan/sponsorship',
        'sponsor_open_collective_url' => 'https://opencollective.com/sound',
        'demo' => env('sound_DEMO', false),
    ],
];
